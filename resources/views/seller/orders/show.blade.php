    ...
    <div class="space-y-4">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div>
                ...
                <img src="{{ asset('storage/' . $order->payment_proof) }}" alt="Bukti Bayar" class="h-48 rounded-xl object-cover border border-gray-200">
            </div>
            @endif
        </div>
        ...
        <!-- Hard Delete -->
        <form method="POST" action="{{ route('seller.orders.destroy', $order) }}" onsubmit="return confirm('Hapus pesanan ini? Data akan disembunyikan.')">
            @csrf @method('DELETE')
