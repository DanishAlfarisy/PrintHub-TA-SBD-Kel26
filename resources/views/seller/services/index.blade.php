...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex gap-2">
            <a href="{{ route('seller.services.trashed') }}" class="px-4 py-2.5 border border-gray-200 text-gray-600 rounded-xl text-sm font-medium hover:bg-gray-50 transition-all">
                    ...
                    <tr class="hover:bg-gray-50 transition-all">
                        ...
                        <td class="py-4 px-4">
                            <div class="flex items-center gap-2">
                                ...
                                <form method="POST" action="{{ route('seller.services.destroy', $service) }}" onsubmit="return confirm('Hapus layanan ini? Anda bisa memulihkannya nanti dari menu Layanan Terhapus.')">
                                    @csrf @method('DELETE')
