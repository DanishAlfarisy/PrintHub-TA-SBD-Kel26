...
class ServiceController extends Controller
{
    ...
    {
        $service = Service::onlyTrashed()->where('seller_id', Auth::id())->findOrFail($id);
        $service->restore();
        return redirect()->route('seller.services')->with('success', 'Layanan berhasil dipulihkan.');
    }
    ...
    public function trashed(Request $request)
    {
        ...
        return view('seller.services.trashed', compact('services', 'search'));
    }
}
