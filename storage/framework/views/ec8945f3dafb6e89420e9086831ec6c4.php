...
<body class="bg-white">
    <nav class="fixed top-0 w-full z-50 bg-white/95 backdrop-blur-md shadow-sm">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('login')); ?>" class="px-5 py-2 text-sm font-semibold text-indigo-600 hover:bg-indigo-50 rounded-xl transition-all">Masuk</a>
                <a href="<?php echo e(route('register')); ?>" class="px-5 py-2 text-sm font-semibold text-white rounded-xl hero-gradient hover:opacity-90 transition-all shadow-lg shadow-indigo-200">Daftar Gratis</a>
            </div>
        </div>
    </nav>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="text-white">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="<?php echo e(route('register')); ?>" class="px-8 py-4 bg-white text-indigo-700 font-bold rounded-2xl hover:shadow-2xl transition-all hover:-translate-y-1 text-lg"><i class="fas fa-rocket mr-2"></i>Mulai Sekarang</a>
                        <a href="<?php echo e(route('login')); ?>" class="px-8 py-4 bg-white/20 backdrop-blur-sm text-white font-semibold rounded-2xl hover:bg-white/30 transition-all text-lg border border-white/30"><i class="fas fa-sign-in-alt mr-2"></i>Masuk</a>
                    </div>
    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                <?php $__currentLoopData = [['fa-file-alt','bg-blue-500','Print Dokumen','HVS, A4, F4'],['fa-palette','bg-pink-500','Print Berwarna','Full color'],['fa-copy','bg-green-500','Fotocopy','Cepat & murah'],['fa-book','bg-orange-500','Jilid','Soft & hard cover'],['fa-layer-group','bg-purple-500','Laminating','Glossy & doff'],['fa-qrcode','bg-teal-500','Scan','Resolusi tinggi'],['fa-image','bg-red-500','Banner','Cetak besar'],['fa-plus-circle','bg-gray-500','Lainnya','Hubungi kami']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$icon,$color,$label,$desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="card-hover bg-white rounded-2xl p-6 text-center shadow-sm border border-gray-100">
                    <div class="w-14 h-14 <?php echo e($color); ?> rounded-2xl flex items-center justify-center mx-auto mb-4"><i class="fas <?php echo e($icon); ?> text-white text-xl"></i></div>
                    <h3 class="font-bold text-gray-800 mb-1"><?php echo e($label); ?></h3>
                    <p class="text-gray-400 text-sm"><?php echo e($desc); ?></p>
                </div>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-4 gap-8">
                <?php $__currentLoopData = [['1','fa-user-plus','from-blue-400 to-blue-600','Daftar Akun','Buat akun sebagai Pembeli'],['2','fa-search','from-purple-400 to-purple-600','Pilih Layanan','Temukan jasa sesuai kebutuhan'],['3','fa-credit-card','from-pink-400 to-pink-600','Bayar','Transfer bank, e-wallet, COD'],['4','fa-box-open','from-green-400 to-green-600','Terima Pesanan','Ambil atau dikirim ke lokasimu']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$step,$icon,$grad,$title,$desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="text-center">
                    <div class="w-16 h-16 bg-gradient-to-br <?php echo e($grad); ?> rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg"><i class="fas <?php echo e($icon); ?> text-white text-2xl"></i></div>
                    <div class="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center mx-auto -mt-2 mb-3 text-sm font-bold text-gray-600"><?php echo e($step); ?></div>
                    <h3 class="font-bold text-gray-800 mb-2 text-lg"><?php echo e($title); ?></h3>
    ...
    <section class="py-20 hero-gradient">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="<?php echo e(route('register')); ?>" class="px-8 py-4 bg-white text-indigo-700 font-bold rounded-2xl hover:shadow-2xl transition-all hover:-translate-y-1 text-lg"><i class="fas fa-shopping-cart mr-2"></i>Daftar sebagai Pembeli</a>
                <a href="<?php echo e(route('register')); ?>" class="px-8 py-4 bg-white/20 border border-white/40 text-white font-bold rounded-2xl hover:bg-white/30 transition-all text-lg"><i class="fas fa-store mr-2"></i>Buka Toko Print</a>
            </div>
        </div>
    </section>
    ...
    <footer class="bg-gray-900 text-white py-10">
        <div class="max-w-7xl mx-auto px-6 text-center">
            ...
            <p class="text-gray-600 text-sm mt-3">&copy; <?php echo e(date('Y')); ?> PrintHub. All rights reserved.</p>
        </div>
    </footer>
</body>
</html>
<?php /**PATH D:\TA-SBD-KEL26-main\TA-SBD-KEL26-main\resources\views/welcome.blade.php ENDPATH**/ ?>