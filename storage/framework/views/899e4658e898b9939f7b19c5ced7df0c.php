...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex gap-2">
            <a href="<?php echo e(route('seller.services.trashed')); ?>" class="px-4 py-2.5 border border-gray-200 text-gray-600 rounded-xl text-sm font-medium hover:bg-gray-50 transition-all">
                <i class="fas fa-trash-alt mr-1"></i>Layanan Terhapus
            </a>
            <a href="<?php echo e(route('seller.services.create')); ?>" class="px-5 py-2.5 bg-indigo-600 text-white rounded-xl text-sm font-semibold hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 mb-6">
        <form method="GET" action="<?php echo e(route('seller.services')); ?>" class="flex gap-3">
    ...
    <div class="bg-white rounded-2xl p-16 text-center shadow-sm border border-gray-100">
        ...
        <a href="<?php echo e(route('seller.services.create')); ?>" class="inline-flex items-center gap-2 mt-3 px-5 py-2.5 bg-indigo-600 text-white rounded-xl text-sm font-medium hover:bg-indigo-700 transition-all">
                    ...
                    <tr class="hover:bg-gray-50 transition-all">
                        <td class="py-4 px-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-semibold text-gray-800 text-sm"><?php echo e($service->name); ?></p>
                                    <p class="text-gray-400 text-xs line-clamp-1"><?php echo e(Str::limit($service->description, 50)); ?></p>
                                </div>
                            </div>
                        </td>
                        <td class="py-4 px-4">
                            <span class="px-2.5 py-1 bg-indigo-100 text-indigo-700 rounded-lg text-xs font-medium"><?php echo e($service->category_label); ?></span>
                        </td>
                        <td class="py-4 px-4">
                            <p class="font-semibold text-gray-800 text-sm">Rp <?php echo e(number_format($service->price_per_unit, 0, ',', '.')); ?></p>
                            <p class="text-gray-400 text-xs">/ <?php echo e($service->unit); ?></p>
                        </td>
                        <td class="py-4 px-4">
                            <form method="POST" action="<?php echo e(route('seller.services.toggle', $service)); ?>">
                                <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                <button type="submit" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold <?php echo e($service->is_active ? 'bg-green-100 text-green-700 hover:bg-green-200' : 'bg-gray-100 text-gray-500 hover:bg-gray-200'); ?> transition-all">
                                    <span class="w-2 h-2 rounded-full <?php echo e($service->is_active ? 'bg-green-500' : 'bg-gray-400'); ?>"></span>
                        ...
                        <td class="py-4 px-4">
                            <div class="flex items-center gap-2">
                                <a href="<?php echo e(route('seller.services.edit', $service)); ?>" class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-all" title="Edit">
                                    <i class="fas fa-edit text-sm"></i>
                                </a>
                                <form method="POST" action="<?php echo e(route('seller.services.destroy', $service)); ?>" onsubmit="return confirm('Hapus layanan ini? Anda bisa memulihkannya nanti dari menu Layanan Terhapus.')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\TA-SBD-KEL26-main\TA-SBD-KEL26-main\resources\views/seller/services/index.blade.php ENDPATH**/ ?>