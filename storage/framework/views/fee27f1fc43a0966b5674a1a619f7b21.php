...
<div>
    ...
    <div class="mb-4 p-4 bg-red-50 border border-red-200 rounded-xl">
        <ul class="space-y-1">
            ...
            <li class="text-red-700 text-sm"><i class="fas fa-exclamation-triangle mr-1"></i><?php echo e($error); ?></li>
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-4">
        ...
        <div>
            ...
            <div class="grid grid-cols-2 gap-3">
                <label class="role-card border-2 rounded-xl p-4 <?php echo e(old('role', 'buyer') === 'buyer' ? 'selected border-indigo-500' : 'border-gray-200'); ?>" id="card-buyer">
                    <input type="radio" name="role" value="buyer" class="hidden" <?php echo e(old('role', 'buyer') === 'buyer' ? 'checked' : ''); ?>>
                ...
                <label class="role-card border-2 rounded-xl p-4 <?php echo e(old('role') === 'seller' ? 'selected border-indigo-500' : 'border-gray-200'); ?>" id="card-seller">
                    <input type="radio" name="role" value="seller" class="hidden" <?php echo e(old('role') === 'seller' ? 'checked' : ''); ?>>
                    <div class="text-center">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <textarea name="address" required rows="2"
                    ...
                    placeholder="Jalan, Kota, Provinsi"><?php echo e(old('address')); ?></textarea>
            </div>
        </div>

        <!-- Seller-only fields -->
        <div id="seller-fields" class="<?php echo e(old('role') === 'seller' ? '' : 'hidden'); ?>">
            <div class="p-4 bg-purple-50 border border-purple-100 rounded-xl space-y-3">
                ...
                <div>
                    ...
                    <input type="text" name="store_name" value="<?php echo e(old('store_name')); ?>"
                ...
                <div>
                    ...
                    <textarea name="store_description" rows="2"
                        ...
                        placeholder="Ceritakan toko kamu..."><?php echo e(old('store_description')); ?></textarea>
                </div>
            </div>
        </div>
    ...
    <div class="mt-4 text-center">
        <p class="text-gray-500 text-sm">Sudah punya akun?
            <a href="<?php echo e(route('login')); ?>" class="text-indigo-600 font-semibold hover:underline">Masuk di sini</a>
        </p>
    </div>
</div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\TA-SBD-KEL26-main\TA-SBD-KEL26-main\resources\views/auth/register.blade.php ENDPATH**/ ?>