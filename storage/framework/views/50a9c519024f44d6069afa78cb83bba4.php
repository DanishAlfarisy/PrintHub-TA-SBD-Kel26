...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'PrintHub'); ?> - Jasa Print & Fotocopy Online</title>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center gap-1">
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->isBuyer()): ?>
                        <a href="<?php echo e(route('buyer.dashboard')); ?>" class="nav-link px-4 py-2 rounded-lg text-sm text-gray-600 <?php echo e(request()->routeIs('buyer.dashboard') ? 'active' : ''); ?>">
                            <i class="fas fa-home mr-1"></i> Dashboard
                        </a>
                        <a href="<?php echo e(route('buyer.services')); ?>" class="nav-link px-4 py-2 rounded-lg text-sm text-gray-600 <?php echo e(request()->routeIs('buyer.services*') ? 'active' : ''); ?>">
                            <i class="fas fa-store mr-1"></i> Layanan
                        </a>
                        <a href="<?php echo e(route('buyer.orders')); ?>" class="nav-link px-4 py-2 rounded-lg text-sm text-gray-600 <?php echo e(request()->routeIs('buyer.orders*') ? 'active' : ''); ?>">
                            <i class="fas fa-shopping-bag mr-1"></i> Pesanan Saya
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('seller.dashboard')); ?>" class="nav-link px-4 py-2 rounded-lg text-sm text-gray-600 <?php echo e(request()->routeIs('seller.dashboard') ? 'active' : ''); ?>">
                            <i class="fas fa-chart-bar mr-1"></i> Dashboard
                        </a>
                        <a href="<?php echo e(route('seller.services')); ?>" class="nav-link px-4 py-2 rounded-lg text-sm text-gray-600 <?php echo e(request()->routeIs('seller.services*') ? 'active' : ''); ?>">
                            <i class="fas fa-box mr-1"></i> Layanan Saya
                        </a>
                        <a href="<?php echo e(route('seller.orders')); ?>" class="nav-link px-4 py-2 rounded-lg text-sm text-gray-600 <?php echo e(request()->routeIs('seller.orders*') ? 'active' : ''); ?>">
                            <i class="fas fa-clipboard-list mr-1"></i> Pesanan Masuk
                        </a>
                        <a href="<?php echo e(route('seller.orders.report')); ?>" class="nav-link px-4 py-2 rounded-lg text-sm text-gray-600 <?php echo e(request()->routeIs('seller.orders.report') ? 'active' : ''); ?>">
            ...
            <div class="flex items-center gap-3">
                    ...
                    <div class="relative group">
                        <button class="flex items-center gap-2 px-3 py-2 rounded-xl bg-gray-50 hover:bg-gray-100 transition-all">
                            ...
                            <div class="hidden sm:block text-left">
                                ...
                                <p class="text-xs text-gray-500 capitalize"><?php echo e(auth()->user()->role === 'buyer' ? 'Pembeli' : 'Penjual'); ?></p>
                            </div>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="px-4 py-2 text-sm text-primary-600 font-medium hover:bg-primary-50 rounded-lg transition-all">Masuk</a>
                    <a href="<?php echo e(route('register')); ?>" class="px-4 py-2 text-sm text-white font-medium rounded-lg gradient-bg hover:opacity-90 transition-all">Daftar</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<footer class="bg-white border-t border-gray-100 mt-16">
    <div class="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p class="text-gray-400 text-sm">&copy; <?php echo e(date('Y')); ?> PrintHub. All rights reserved.</p>
        </div>
    </div>
</footer>
...
<?php /**PATH D:\TA-SBD-KEL26-main\TA-SBD-KEL26-main\resources\views/layouts/app.blade.php ENDPATH**/ ?>